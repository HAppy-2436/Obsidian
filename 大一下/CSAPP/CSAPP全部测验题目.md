...
> 来源：超星学习通 / 课程：计算机系统 / 共 11 个 test--week 作业
> 范围：CSAPP 第 2-9 章（信息存储 → 虚拟内存）
> **缺漏**：week 7 / 10 这门课未布置（无题目）
...
## Week 6 — 3.7 过程 + 3.8 数组

> workId: `52379173`　|　本套题共 5 道
...
（同上汇编代码）汇编代码如上所示，call 指令执行之后，哪个值被压入栈中
...
（同上汇编代码）汇编代码如上所示，call 指令执行之后（即进入了被调用函数），%rip 值为
