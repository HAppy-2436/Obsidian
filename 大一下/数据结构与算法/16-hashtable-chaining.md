...
prerequisites:
  - 13-hashmap-basic
source_url: https://labuladong.online/zh/algo/data-structure-basic/hashtable-chaining/
...
>
> ⚠️ **付费章节**：本文的"成为会员即可解锁"截断部分，已在 `> [!info] 📌 付费章节补全内容` 中补全完整代码（C++，namespace dsa）+ 与线性探查法的对比。
