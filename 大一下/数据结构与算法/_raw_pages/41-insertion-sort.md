<!-- TAG: 41-insertion-sort | URL: https://labuladong.online/zh/algo/data-structure-basic/insertion-sort/ -->
...
插入排序是基于 
选择排序
 的一种优化，将 nums[sortedIndex] 插入到左侧的有序数组中。对于有序度较高的数组，插入排序的效率比较高。
...
前文 
选择排序所面临的问题
 中分析了选择排序遇到的几个问题，然后逐步优化写出了 
冒泡排序
，使得排序算法具有稳定性，且能够在输入数组的有序度较高时提前终止，提升效率。
