<!-- TAG: 36-graph-minimum-spanning-tree | URL: https://labuladong.online/zh/algo/data-structure-basic/graph-minimum-spanning-tree/ -->
...
Kruskal 算法相对简单一些，只需要先对图中的所有边按照权重排序，然后借助 
Union-Find 并查集算法
 即可找到最小生成树。
