...
- [[23-二叉树基本概念|二叉树基础]] — 红黑树的逻辑结构
- [[27-二叉搜索树原理|BST 原理]] — 红黑树是「自平衡的 BST」
- [[28-二叉搜索树实现|TreeMap / TreeSet 实现]] — 工业级 TreeMap 的底层就是红黑树
- [[30-并查集原理|并查集]] — 另一种「森林」结构，但只关心连通性
- [[50-赫夫曼编码|赫夫曼树]] — 另一种「自平衡树」，按权重平衡
