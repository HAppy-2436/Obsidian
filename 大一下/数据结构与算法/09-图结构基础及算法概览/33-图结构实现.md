...
- **DFS / BFS 遍历**：见 [[34-图的遍历|图遍历]]
- **最短路径**：Dijkstra / SPFA / Floyd（[[37-最短路径算法|最短路径概览]]）
- **最小生成树**：Kruskal（依赖邻接表 + Union-Find）/ Prim（[[36-最小生成树|最小生成树概览]]）
- **欧拉回路**：Hierholzer（[[38-欧拉图|欧拉图]]）
...
- [[32-图的基本术语|图的基本术语]] — 图的数学定义
- [[25-N叉树遍历|N 叉树遍历]] — 图遍历的逻辑原型
- [[34-图的遍历|图遍历]] — 本章 API 的第一个用户
- [[06-链表实现|链表实现]] — 邻接表的底层存储
- [[02-数组原理|数组原理]] — 邻接矩阵的底层存储
- [[30-并查集原理|并查集]] — 配合邻接表做 Kruskal
