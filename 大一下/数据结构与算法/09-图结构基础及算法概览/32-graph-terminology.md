...
url: https://labuladong.online/zh/algo/data-structure-basic/graph-terminology/
---
...
2 V 2 ，我们说这幅图是 稠密图（Dense Graph）；如果只有很少的边，即

E 远小于

2 V 2 ，我们说这幅图是 稀疏图（Sparse Graph）。
