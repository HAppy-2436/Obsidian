...
**思路**：仿照 [[44-快速排序|快速排序]] 的 partition，每次只递归包含第 K 大元素的那一侧，期望复杂度 O(N)，最坏 O(N²)。
...
- **Huffman 编码**：见 [[50-赫夫曼编码|赫夫曼编码]]，每次合并权重最小的两个节点（用优先队列实现贪心）。
...
- [[21-二叉堆原理|二叉堆原理]] — 理解 swim/sink 的理论基础
- [[45-堆排序|堆排序]] — 堆最重要的应用之一
- [[44-快速排序|快速排序]] — Top K 问题的另一种解法
- [[50-赫夫曼编码|赫夫曼编码]] — 优先队列的另一个重要应用


## 关联章节

- [[21-二叉堆原理|二叉堆核心原理及可视化]]
